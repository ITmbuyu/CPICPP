...
namespace CPICPP.Controllers
{
    public class SchoolsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("SchoolId,SchoolName,SchoolAddress,SchoolCity,SchoolState,SchoolPhone")] School school)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("SchoolId,SchoolName,SchoolAddress,SchoolCity,SchoolState,SchoolPhone")] School school)
        {
