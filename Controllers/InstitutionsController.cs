...
namespace CPICPP.Controllers
{
    public class InstitutionsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("InstitutionId")] Institution institution)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("InstitutionId")] Institution institution)
        {
